...
@IBDesignable class GridView: UIView {
    ...
    func drawStatus(rect: CGRect){
        var xPos: CGFloat = 0
        var yPos: CGFloat = 0
        let xAdd = bounds.width/CGFloat(rows)
        let yAdd = bounds.height/CGFloat(cols)
        for h in 0..<rows{
            for w in 0..<cols{
